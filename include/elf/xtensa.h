...
START_RELOC_NUMBERS (elf_xtensa_reloc_type)
     ...
     RELOC_NUMBER (R_XTENSA_TLS_GOTTPOFF, 70)
     RELOC_NUMBER (R_XTENSA_GOTTLSDESC, 71)
     RELOC_NUMBER (R_XTENSA_TLSDESC, 72)
     RELOC_NUMBER (R_XTENSA_TLS_FUNCDESC, 73)
     RELOC_NUMBER (R_XTENSA_TLS_GOT, 74)
     RELOC_NUMBER (R_XTENSA_TLS_TPOFF_PTR, 75)
     RELOC_NUMBER (R_XTENSA_TLS_TPOFF_LOAD, 76)
