...
START_RELOC_NUMBERS (elf_xtensa_reloc_type)
     ...
     RELOC_NUMBER (R_XTENSA_GOT, 63)
     RELOC_NUMBER (R_XTENSA_GOTOFF, 64)
     RELOC_NUMBER (R_XTENSA_GOTFUNCDESC, 65)
     RELOC_NUMBER (R_XTENSA_GOTOFFFUNCDESC, 66)
     RELOC_NUMBER (R_XTENSA_FUNCDESC, 67)
     RELOC_NUMBER (R_XTENSA_FUNCDESC_VALUE, 68)
     RELOC_NUMBER (R_XTENSA_TLS_GOTTPOFF, 69)
     RELOC_NUMBER (R_XTENSA_GOTTLSDESC, 70)
     RELOC_NUMBER (R_XTENSA_TLSDESC, 71)
     RELOC_NUMBER (R_XTENSA_TLS_FUNCDESC, 72)
     RELOC_NUMBER (R_XTENSA_TLS_GOT, 73)
     RELOC_NUMBER (R_XTENSA_TLS_TPOFF_PTR, 74)
     RELOC_NUMBER (R_XTENSA_TLS_TPOFF_LOAD, 75)
